...
on 2026-08-27; the Residency line has since been softened but these have not, and the
...
- **`about.tsx:515`** — "structured tooling supports **subject-access and erasure**
...
- **`about.tsx:516`** — "Full data-governance documentation … available for review".
...
- **`about.tsx:533`** — "Processing: **ICO registered**." A statement of regulatory status.
