...
export default function App() {
  ...
  if (loading) return <Shell><p className="text-gray-500 text-sm">Loading rounds…</p></Shell>
  if (error) return <Shell><p className="text-red-600 text-sm">Error: {error}</p></Shell>
